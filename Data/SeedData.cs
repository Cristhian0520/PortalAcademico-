...
namespace PlataformaAcademicaApp.Data
{
    public static class SeedData
    {
        public static async Task EnsureSeedDataAsync(IServiceProvider serviceProvider)
        {
            ...
            // Crear cursos iniciales si la tabla está vacía
            if (!db.Cursos.Any())
            {
                db.Cursos.AddRange(
                    new Curso
                    {
                        ...
                        HorarioFin = TimeSpan.Parse("10:00"),
                        Activo = true
                    },
                    new Curso
                    {
                        ...
                        HorarioFin = TimeSpan.Parse("12:00"),
                        Activo = true
                    },
                    new Curso
                    {
                        ...
                        Creditos = 3,
                        CupoMaximo = 20,
                        HorarioInicio = TimeSpan.Parse("14:00"),
                        HorarioFin = TimeSpan.Parse("16:00"),
                        Activo = true
                    }
                );
